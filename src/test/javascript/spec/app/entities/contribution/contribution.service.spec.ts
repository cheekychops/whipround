    ...
    describe('Contribution Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Contribution', () => {
                service.create(new Contribution(null)).subscribe(received => {
            ...
            it('should update a Contribution', () => {
                service.update(new Contribution(123)).subscribe(received => {
            ...
            it('should return a Contribution', () => {
            ...
            it('should return a list of Contribution', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Contribution(123)]);
            });
